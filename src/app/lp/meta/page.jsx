        ...
        <div className="mx-auto max-w-2xl py-16 lg:py-20 px-2">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-400">
              My name is Colin and I started Growthforge after leaving my
              decade-long career as a software engineer, frustrated by all the
              ‘advice’ out there on SEO, SEM, and online marketing. Turns out,
              most of it is complete crap.
              <br />
              <br />
              In this course, I'm going to show you what you actually need to do
              to move the needle in your business, and how to set up the systems
              and practices that will keep you growing steadily year after year.
            </p>
